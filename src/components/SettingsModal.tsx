    ...
    >
      <div className="bg-[var(--surface)] border border-[var(--border2)] rounded-xl p-6 w-[360px] max-w-full shadow-2xl flex flex-col max-h-[90vh] overflow-y-auto gap-4 animate-[fadeIn_0.15s_ease-out]">
        ...
        <div className="border-t border-[var(--border)] pt-3.5">
          <div className="p-3 bg-[var(--surface)] border border-[var(--border2)] rounded-lg flex items-center justify-between text-xs">
            <div className="flex items-center gap-2">
              <span className="text-[var(--purple)] font-bold">🔗 GAS同期・シート設定</span>
              <span className="text-[10px] text-[var(--muted)]">「取り込み」ハブに一元化されました</span>
            </div>
            <button
              type="button"
              onClick={onClose}
              className="text-[var(--blue)] hover:underline font-medium cursor-pointer"
            >
              📥 取り込みを開く →
            </button>
          </div>

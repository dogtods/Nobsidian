...
# buildAnalysisPrompt is fixed (lines 1473-1621 in current view_file 1470-1650)
# buildBulkAnalysisPrompt is fixed (lines 1575-1650 in current view_file 1575-1650)

# But wait, there is a duplicated buildBulkAnalysisPrompt tail at 1701-1715.
# And a mangled runVisualExtraction at 1789.

# Let's just rewrite the whole section from 1651 to 1966.
...
# Reassemble the file
# Keep everything before line 1651 (index 1650)
# Insert new_content
# Keep everything after line 1965 (index 1965)

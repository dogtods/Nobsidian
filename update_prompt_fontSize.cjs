...
1. すべてのコードブロックの先頭(グラフ種別の行より前)に、次のinit行を必ず挿入すること。文字サイズを小さく(11px)して枠に収まりやすくしています。
%%{init: {'theme': 'dark', 'themeVariables': { 'primaryColor': '#000000', 'primaryTextColor': '#ffffff', 'primaryBorderColor': '#ffffff', 'lineColor': '#ffffff', 'textColor': '#ffffff', 'background': '#000000', 'mainBkg': '#000000', 'nodeBorder': '#ffffff', 'clusterBkg': '#000000', 'edgeLabelBackground':'#000000', 'fontSize': '11px' }}}%%
...
- flowchartのノード内テキストは、絶対に枠からはみ出さないよう極力短く（1行あたり10文字以内目安）し、必要に応じて<br>で改行してください。文字サイズを小さくしているため、短く区切って改行すればノード内に収まります。
